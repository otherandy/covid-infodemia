	    ...
	    <script type="text/javascript">
			...
			for (var i = 0; i< 10; i++) {
				...
				if(i==9||i==2){
					...
					r.fecha="junio 2020";
					r.resumen="La fisiopatología de este virus continúa siendo desconocida. Múltiples estudios indican que los pacientes infectados por COVID-19 ttienen altas concentraciones de interleucina (IL) ";
				}
				else if(i%3==0){
					...
					r.fecha="Mayo 2019";
					r.resumen="beta, interferón (IFN) gamma, proteína 10 inducible por IFN (IP) y proteína quimiotáctica monocitaria (MCP) 1. Se ha demostrado que los pacientes más graves tienen ";
				}
				else if(i%2==0){
					r.video="1";
					r.imagen="1";
					r.fecha="Agosto 2000";
					r.resumen="La fisiopatología de este virus continúa siendo desconocida. Múltiples estudios indican que los pacientes infectados por COVID-19 ttienen altas concentraciones de interleucina (IL) 1 beta, interferón (IFN) gamma, proteína 10 inducible por IFN (IP) y proteína quimiotáctica monocitaria (MCP) 1. Se ha demostrado que los pacientes más graves tienen ";
				}
				else{
					r.imagen="https://www.paho.org/sites/default/files/card/2021-03/covid-19-virus-aqua-bk.jpg";
					r.video="1";
					r.fecha="diciembre 2019";
					r.resumen="La fisiopatología de este virus continúa siendo desconocida. Múltiples estudios indican que los pacientes infectados por COVID-19 ttienen altas concentraciones de interleucina (IL) 1 beta, interferón (IFN) gamma, proteína 10 inducible por IFN (IP) y proteína quimiotáctica monocitaria (MCP) 1. Se ha demostrado que los pacientes más graves tienen efjfhfnlñmlmfkngnkregnkre   fkrniojtijfmewf f fiefni4ti3mfmfinfkned fiowernhurjiemopewmwqmqw";
				}
